...
This repository is the official implementation associated with the JOSS publication.
...
A key strength is that a substantial portion of the regional datasets has been analyzed by the author using consistent analytical protocols, ensuring high comparability across sampling campaigns.
