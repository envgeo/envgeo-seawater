...
- 変更: 現在のアプリおよび各ページのバージョン表示を `1.30` に統一。
...
- 変更: 退役したナビゲーションページ、重複ページ、古い beta ページは、ローカルバックアップと GitHub release/tag 履歴で確認できるため、現在のソースツリーから除外。
